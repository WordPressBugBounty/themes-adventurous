...
= 3.4.4 (Released: November 22, 2023) =
* Updated: WordPress 6.4 ready

= 3.4.3 (Released: November 27, 2022) =
* Removed: Fitvids JS script

= 3.4.2 (Released: August 29, 2022) =
* Updated: WordPress 6.0 ready

= 3.4.1 (Released: February 05, 2022) =
* Updated: WordPress 5.9 ready

= 3.4 (Released: September 16, 2021) =
* Added: Core Blocks Support
* Bug Fixed: Text domain issue
* Bug Fixed: Added underline on the anchor tag
* Bug Fixed: Removed extra ; from adventurous-functions.php file
