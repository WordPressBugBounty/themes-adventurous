...
function adventurous_scripts() {
	...
	wp_enqueue_style( 'adventurous-block-style', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/blocks.css', array( 'adventurous-style' ), '4.4.4' );
	 ...
	 */
	wp_enqueue_script( 'adventurous-custom', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/adventurous-custom.min.js', array( 'jquery' ), date( 'Ymd-Gis', filemtime( get_template_directory() . '/js/adventurous-custom.min.js' ) ), true );
 ...
 */
function adventurous_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'adventurous-block-editor-style', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/editor-blocks.css' );
}
add_action( 'enqueue_block_editor_assets', 'adventurous_block_editor_styles' );
